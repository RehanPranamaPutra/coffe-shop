    ...
    <div class="flex min-h-screen" x-data="{ sidebarOpen: true, mobileMenuOpen: false }">
        ...
        <aside
            ...
            <button @click="sidebarOpen = !sidebarOpen"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 transition-transform duration-500"
            ...
            <div>
                <!-- LOGO SECTION -->
                <div class="mb-10 mt-2 flex items-center overflow-hidden transition-all duration-300"
                    :class="sidebarOpen ? 'justify-start px-2' : 'justify-center px-0'">
                ...
                <nav class="space-y-1.5">
                    ...
                    <a href="{{ route('dashboard') }}"
                        ...
                        <span x-show="sidebarOpen" x-transition.opacity
                            class="ml-3 font-medium whitespace-nowrap">Beranda</span>
                    </a>

                    <!-- MENU KATEGORI (Baru) -->
                    <!-- Sangat penting untuk mengelompokkan Coffee, Non-Coffee, Mojito -->
                    <a href="{{ route('kategori.index') }}"
                        class="flex items-center p-3 rounded-xl transition-all duration-200 group {{ request()->routeIs('kategori.*') ? 'bg-[#cc9966] shadow-md' : 'hover:bg-white/10' }}"
                        :class="sidebarOpen ? 'justify-start' : 'justify-center'" title="Kategori Menu">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="currentColor"
                            viewBox="0 0 20 20">
                        ...
                        <span x-show="sidebarOpen" x-transition.opacity
                            class="ml-3 font-medium whitespace-nowrap">Kategori Menu</span>
                    </a>

                    <!-- Produk (Sekarang berfungsi sebagai Induk Menu) -->
                    <a href="{{ route('produk.index') }}"
                        ...
                        <span x-show="sidebarOpen" x-transition.opacity
                            class="ml-3 font-medium whitespace-nowrap">Daftar Menu</span>
                    </a>

                    <!-- Promo (Dihubungkan ke Variasi) -->
                    <a href="{{ route('promo.index') }}"
                        ...
                        :class="sidebarOpen ? 'justify-start' : 'justify-center'" title="Manajemen Promo">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-shrink-0" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M5 2a2 2 0 00-2 2v14l4-2 4 2 4-2 4 2V4a2 2 0 00-2-2H5zm4.707 9.293a1 1 0 00-1.414-1.414L7 11.586l-.293-.293a1 1 0 00-1.414 1.414l1 1a1 1 0 001.414 0l2-2z"
                                clip-rule="evenodd" />
                        </svg>
                        <span x-show="sidebarOpen" x-transition.opacity class="ml-3 font-medium whitespace-nowrap">Promo
                            Variasi</span>
                    </a>
                    ...
                    @can('roleOwner')
                        ...
                        <a href="{{ route('gaji.index') }}"
                            ...
                            <span x-show="sidebarOpen" x-transition.opacity
                                class="ml-3 font-medium whitespace-nowrap">Gaji</span>
                        </a>
                        ...
                        <a href="{{ route('laporan.keuangan') }}"
                            ...
                            <span x-show="sidebarOpen" x-transition.opacity
                                class="ml-3 font-medium whitespace-nowrap">Laporan</span>
                        </a>
                    @endcan
                    ...
                    <div x-data="{ dropdownOpen: false }" class="mt-4">
                        ...
                        <div x-show="dropdownOpen && sidebarOpen" x-cloak
                            x-transition:enter="transition ease-out duration-100" class="ml-9 mt-1 space-y-1">
                            <a href="{{ route('penjualan.index') }}"
                                class="block p-2 text-sm text-gray-300 hover:text-white hover:font-bold transition">Penjualan</a>
                            <a href="{{ route('pembelian.index') }}"
                                class="block p-2 text-sm text-gray-300 hover:text-white hover:font-bold transition">Pembelian</a>
                        </div>
                    </div>
                </nav>
            </div>
            ...
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-[#cc9966] group-hover:text-white"
                ...
                <div class="px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    <div class="flex items-center gap-4">
                        ...
                        <button @click="mobileMenuOpen = !mobileMenuOpen"
                            class="lg:hidden p-2 rounded-lg hover:bg-gray-100 transition focus:outline-none">
                            <svg class="h-6 w-6 text-[#7a3939]" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="flex items-center gap-2 group p-1.5 rounded-lg hover:bg-gray-100 transition-all duration-200"
                            title="Edit Profil">

                            <div class="hidden sm:block text-right">
                                <p
                                    class="text-sm font-bold text-gray-700 group-hover:text-[#cc9966] leading-tight transition-colors">
                            ...
                            <!-- Icon Settings/Edit -->
                            <div
                                class="bg-gray-100 p-2 rounded-full group-hover:bg-[#cc9966]/10 group-hover:text-[#cc9966] text-gray-500 transition-all">
        ...
        <div x-show="mobileMenuOpen" x-cloak class="lg:hidden fixed inset-0 z-50 overflow-hidden">
            ...
            <div class="absolute inset-y-0 left-0 w-3/4 max-w-xs bg-[#7a3939] shadow-xl p-6 flex flex-col justify-between"
                x-show="mobileMenuOpen" x-transition:enter="transform transition ease-in-out duration-300"
                ...
                <div>
                    ...
                    <nav class="space-y-4">
                        <a href="{{ route('dashboard') }}"
                            class="flex items-center text-white p-3 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-[#cc9966]' : '' }}">Beranda</a>
                        <a href="{{ route('produk.index') }}"
                            class="flex items-center text-white p-3 rounded-lg {{ request()->routeIs('produk.index') ? 'bg-[#cc9966]' : '' }}">Produk</a>
                        <a href="{{ route('promo.index') }}"
                            class="flex items-center text-white p-3 rounded-lg {{ request()->routeIs('promo.index') ? 'bg-[#cc9966]' : '' }}">Promo</a>
                        <a href="{{ route('gaji.index') }}"
                            class="flex items-center text-white p-3 rounded-lg {{ request()->routeIs('gaji.index') ? 'bg-[#cc9966]' : '' }}">Gaji</a>
                        <a href="{{ route('laporan.keuangan') }}"
                            class="flex items-center text-white p-3 rounded-lg {{ request()->routeIs('laporan.keuangan') ? 'bg-[#cc9966]' : '' }}">Laporan</a>
                    </nav>
                </div>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit"
                        class="w-full p-4 bg-red-600 text-white rounded-xl font-bold shadow-lg">Keluar</button>
                </form>
            </div>
        </div>
        ...
        <nav
            class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-[#cc9966]/30 shadow-[0_-5px_15px_rgba(0,0,0,0.05)] z-40">
            <div class="grid grid-cols-5 h-16">
                <a href="{{ route('dashboard') }}"
                    class="flex flex-col items-center justify-center {{ request()->routeIs('dashboard') ? 'text-[#cc9966]' : 'text-gray-400' }}">
                ...
                <a href="{{ route('produk.index') }}"
                    class="flex flex-col items-center justify-center {{ request()->routeIs('produk.index') ? 'text-[#cc9966]' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                    </svg>
                ...
                <a href="{{ route('promo.index') }}"
                    class="flex flex-col items-center justify-center {{ request()->routeIs('promo.index') ? 'text-[#cc9966]' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="{{ route('gaji.index') }}"
                    class="flex flex-col items-center justify-center {{ request()->routeIs('gaji.index') ? 'text-[#cc9966]' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a1 1 0 100-2 1 1 0 000 2z" />
                    </svg>
                ...
                <a href="{{ route('laporan.keuangan') }}"
                    class="flex flex-col items-center justify-center {{ request()->routeIs('laporan.keuangan') ? 'text-[#cc9966]' : 'text-gray-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                        <path
                            d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z" />
                    </svg>
