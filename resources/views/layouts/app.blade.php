...
<body class="font-sans antialiased">
    ...
    <div class="flex min-h-screen bg-gray-100" x-data="{ sidebarOpen: false }">
        ...
        <div class="bg-[#7a3939] text-white flex flex-col justify-between p-4 shadow-xl sticky top-0 h-screen overflow-hidden
            ...
            <header
                ...
                <div class="px-8 py-4 flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-[#7a3939] to-[#cc9966] rounded-xl flex items-center justify-center shadow-lg">
                        ...
                        <h2
                            class="text-2xl font-bold bg-gradient-to-r from-[#7a3939] to-[#cc9966] bg-clip-text text-transparent">
                            Ringkasan Beranda
                        </h2>
                    </div>
                    ...
                    <div class="flex items-center space-x-6">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-6 w-6 text-gray-500 hover:text-[#cc9966] cursor-pointer transition duration-150"
                        ...
                        <div class="relative cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 text-gray-500 hover:text-[#cc9966] transition duration-150"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
